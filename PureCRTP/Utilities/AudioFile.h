...
public:
	...
	AudioFormatType getFormat() const;
    ...
    /** Sets the number of channels. New channels will have the correct number of samples and be initialized to zero */
	...
	// Set the audio format (PCM or Float)
	void setAudioFormat(AudioFormatType newAudioFormat);
...
private:
	...
	AudioFormatType AudioFormat = AudioFormatType::PCM;
    ...
    static int getIndexOfString (std::vector<uint8_t>& source, const std::string& s);
    ...
    //=============================================================
    static bool writeDataToFile (std::vector<uint8_t>& fileData, const std::string& filePath);
